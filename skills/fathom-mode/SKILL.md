...
(This general tangential handling is for ordinary in-session turns. The AWAITING_APPROVAL state — when the user is responding to a compiled plan — has its own state-specific tangential handling delivered via the hook reminder.)
