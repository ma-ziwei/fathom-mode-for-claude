...
The Score is intentionally asymptotic to 100% but never reaches it — perfect understanding is a lie. Treat 85%+ as "deep enough to draft a plan if the user wants to."
...
- Don't push them to draft a plan — let them choose. Some users want to go deeper before committing.
...
- **Score is not a stopping rule.** Drafting a plan is always user-triggered via `/fathom-plan`. Never auto-draft.
